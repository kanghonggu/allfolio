 ...
 * 화면에서 다시 만든다.**
 *
 * ## 🔴 저장하는 값은 사용자가 친 문자열이 아니다
 *
 * [onConfirm]에 넘기는 것은 **서버가 정규화해 돌려준 `ref`**다. `116238 CHSJ`를 쳐도
 * 서버가 `116238`로 돌려주면 그 값이 저장된다 — 평가 배치가 그 키로 찾기 때문이다.
 *
 * ## 표본이 없어도 등록을 막지 않는다
 *
  ...
  return (
    <div className="border border-line-soft bg-surface-muted p-3.5">
      ...
      <p className="mt-1.5 text-[11px] text-fg-faint">
        보증서·케이스백에 적힌 번호입니다. 뒤에 붙는 소재 기호(<code>116238 CHSJ</code>)는
        빼고 적어도 됩니다 — 서버가 맞춰 줍니다.
      </p>
