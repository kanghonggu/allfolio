...
| 코드 | 소스 | 단위 | 실측 |
|---|---|---|---|
| `GOLD_KRX` | 금융위 일반상품시세정보 `getGoldPriceInfo` · 종목 `04020000`(금 99.99_1kg) | **KRW/g** | 200,570 (2026-08-13) |
...
| 구리 13,552 · 금 200,570 · 종합지수 194.9 | 100 초과 | ❌ |
...
```kotlin
/** 시세 — 0 이하는 파싱 사고다. 상한은 걸지 않는다 (구리 13,552·금 200,570·지수 194.9가 다 정상) */
